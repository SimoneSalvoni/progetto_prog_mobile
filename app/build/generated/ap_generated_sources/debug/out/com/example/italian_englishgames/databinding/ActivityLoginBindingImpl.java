...
public class ActivityLoginBindingImpl extends ActivityLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.newaccount, 5);
        sViewsWithIds.put(R.id.errorEmailLogin, 6);
        sViewsWithIds.put(R.id.errorPasswordLogin, 7);
        sViewsWithIds.put(R.id.generalErrorLogin, 8);
    }
    // views
    @NonNull
