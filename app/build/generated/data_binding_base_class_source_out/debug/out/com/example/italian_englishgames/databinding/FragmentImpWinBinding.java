...
public final class FragmentImpWinBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentImpWinBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentImpWinBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentImpWinBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_imp_win, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentImpWinBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentImpWinBinding((ConstraintLayout) rootView, constraintLayout, goHomeButton,
