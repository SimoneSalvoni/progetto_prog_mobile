...
public final class GridElementBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static GridElementBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static GridElementBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.grid_element, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static GridElementBinding bind(@NonNull View rootView) {
