...
public class ImpLoseFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private ImpLoseFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private ImpLoseFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static ImpLoseFragmentArgs fromBundle(@NonNull Bundle bundle) {
    ImpLoseFragmentArgs __result = new ImpLoseFragmentArgs();
    bundle.setClassLoader(ImpLoseFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    ImpLoseFragmentArgs that = (ImpLoseFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(ImpLoseFragmentArgs original) {
    ...
    @NonNull
    public ImpLoseFragmentArgs build() {
      ImpLoseFragmentArgs result = new ImpLoseFragmentArgs(arguments);
      return result;
    }
