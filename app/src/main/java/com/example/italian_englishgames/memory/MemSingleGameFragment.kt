...
import com.example.italian_englishgames.databinding.FragmentMemSingleGameBinding
import com.google.android.material.snackbar.Snackbar


class MemSingleGameFragment : Fragment(), GridAdapter.OnItemClickListener {

    lateinit var binding: FragmentMemSingleGameBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_mem_single_game, container, false)
        return binding.root
